...
├── vercel.json                 ← Конфігурація Vercel (rewrites)
├── api/
│   └── send-email.js           ← Vercel serverless функція відправки уроків (Brevo API)
...
Нейтральний фідбек без персонажа: ✅ / ❌ + коротке повідомлення (правильно/неправильно, без коментарів від імені маскота).
